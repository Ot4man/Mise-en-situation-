...
function afficherEmployes(){ 
    employees.forEach(employe => {
        const employetable = document.getElementById("employees-tbody");
        ...
        <th>${employe.skills}</th>
        <th>${employe.joinDate}</th>
        <th>${employe.email}</th>
        <th>${employe.projects}</th>
        <th>${employe.isActive}</th>
        <td>${employe.languages}</td>
        </tr>
        </thead>`;
        employetable.appendChild(tab);
...
const AfiicheBtn = document.getElementById("affichebtn");
const Delete = document.getElementById("deletbtn");


// const AfiicheBtn = document.getElementsByClassName("affichebtn");
// const Delete = document.getElementsByClassName("deletbtn");
AfiicheBtn.addEventListener("click",()=>{
    console.log("j");
    table.classList.remove("hidden");
    // tab.className.remove("hidden");
    console.log("55")
})

Delete.addEventListener("click",()=>{
    table.classList.add("hidden")
    // tab.className.add("hidden");
})
